...
export default function LoginPage() {
  ...
  // Surface errors passed back by /auth/callback after a failed OAuth attempt.
  useEffect(() => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (userData?.role === "admin") {
          ...
          setError("Ce compte est réservé à l'administration. Utilisez /admin/login.");
          return;
        } else if (userData?.role === "auto_ecole") {
      ...
      <div className="max-w-md mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex bg-gradient-to-r from-gray-50/80 to-gray-100/50 p-2">
            <button
              onClick={() => { setActiveTab("login"); setError(null); setSuccess(false); }}
            ...
            <button
              onClick={() => { setActiveTab("register"); setError(null); setSuccess(false); }}
              className={`flex-1 py-4 text-sm font-bold rounded-xl transition-all duration-300 relative ${
                activeTab === "register"
                  ? "text-blue-600 bg-white shadow-md"
                  : "text-gray-500 hover:text-gray-700 hover:bg-white/50"
              ...
              {activeTab === "login" ? (
                ...
                >
                  ...
                  <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <Link href="/forgot-password" className="text-blue-600 font-semibold hover:underline transition-colors">
                        Mot de passe oublié ?
                      </Link>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-4 bg-blue-600 text-white font-bold text-lg rounded-xl hover:bg-blue-700 focus:ring-4 focus:ring-blue-500/20 transition-all shadow-lg shadow-blue-600/20 hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 flex items-center justify-center gap-2 mt-4"
                    >
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Rejoignez-nous !</h1>
